  ...
  const onDrop = useCallback(async (acceptedFiles: File[]) => {
    if (acceptedFiles.length > 0) {
      ...
      if (name && acceptedFiles[0]) {
        ...
        try {
          const response = await fetch('http://localhost:8081/task/createTask', {
            method: 'POST',
            body: formData,
          });
      ...
      <DefaultLayout>
        {isInputVisible ? (
            <div className="max-w-md mx-auto mt-6">
              <label className="block text-lg font-medium text-gray-700 mb-2" htmlFor="task-name">
                            ...
                            <section className="py-10 bg-white sm:py-16 lg:py-24">
                              <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                                <div className="max-w-2xl mx-auto text-center">
                                  <svg className="mx-auto w-14 h-14 transform rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="relative w-full max-w-md mx-auto overflow-hidden bg-white rounded-xl">
                  <div className="p-8">
                    <div className="text-center">
                      ...
                      <p className="mt-3 text-base font-medium text-gray-600">
                        Once the file upload is complete, you can leave the window, and the result will appear in the task.
                      </p>
                    </div>
                  </div>
                </div>
